...
namespace CSA_Project.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            string host = setting.ServerIP+":"+setting.ServerPort;
            ...
            string args = "-h "+host+" -s "+src+" -m " + model + " -p " + weights;
            var s = run_cmd(python27, streamer, args);
            return View();
        }

      
        public string run_cmd(string python, string py_script, string args)
        {
            ProcessStartInfo start = new ProcessStartInfo();
            start.FileName = python; //"PATH_TO_PYTHON_EXE";
            start.Arguments = string.Format("\"{0}\" \"{1}\"", py_script, args);
